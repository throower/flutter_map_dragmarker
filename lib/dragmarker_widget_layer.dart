...
class DragMarkerWidget extends StatefulWidget {
  ...
  DragMarkerWidget({required this.mapState, required this.marker, AnchorPos? anchorPos, required this.stream, this.options }) : anchor = Anchor.forPos(anchorPos, marker.width, marker.height);
